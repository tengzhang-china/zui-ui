/* Copyright© 2000 - 2020 TongMap Software Co.Ltd. All rights reserved.
 * This program are made available under the terms of the Apache License, Version 2.0
 * which accompanies this distribution and is available at http://www.apache.org/licenses/LICENSE-2.0.html. */
import { TongMap } from '../TongMap';
import { Util } from '../common/commontypes/Util';

/**
 * @class TongMap.ThemeStyle
 * @classdesc 客户端专题图风格类。
...
export class ThemeStyle {
  ...
  constructor(options) {
    options = options || {};
    /**
         * @member {boolean} [TongMap.ThemeStyle.prototype.fill=true]
         * @description 是否填充，不需要填充则设置为 false。如果 fill 与 stroke 同时为 false，将按 fill 与 stroke 的默认值渲染图层。
         */
    this.fill = true;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.fillColor="#000000"]
         * @description 十六进制填充颜色。
         */
    this.fillColor = "#000000";
    /**
         *  @member {number} [TongMap.ThemeStyle.prototype.fillOpacity=1]
         *  @description 填充不透明度。取值范围[0, 1]。
         */
    this.fillOpacity = 1;
    /**
         * @member {boolean} [TongMap.ThemeStyle.prototype.stroke=false]
         * @description  是否描边，不需要描边则设置为false。如果 fill 与 stroke 同时为 false，将按 fill 与 stroke 的默认值渲染图层。
         */
    this.stroke = false;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.strokeColor="#000000"]
         * @description  十六进制描边颜色。
         */
    this.strokeColor = "#000000";
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.strokeOpacity=1]
         * @description  描边的不透明度。取值范围[0, 1]。
         */
    this.strokeOpacity = 1;
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.strokeWidth=1]
         * @description  线宽度/描边宽度。
         */
    this.strokeWidth = 1;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.strokeLinecap="butt"]
         * @description  线帽样式；strokeLinecap 有三种类型 “butt", "round", "square" 。
         */
    this.strokeLinecap = "butt";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.strokeLineJoin="miter"]
         * @description  线段连接样式；strokeLineJoin 有三种类型 “miter", "round", "bevel"。
         */
    this.strokeLineJoin = "miter";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.strokeDashstyle="solid"]
    ...
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.pointRadius=6]
         * @description   点半径。单位为像素。
         */
    this.pointRadius = 6;
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.shadowBlur=0]
         * @description   阴影模糊度，（大于 0 有效）。注：请将 shadowColor 属性与 shadowBlur 属性一起使用，来创建阴影。
         */
    this.shadowBlur = 0;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.shadowColor='#000000']
         * @description  阴影颜色。注：请将 shadowColor 属性与 shadowBlur 属性一起使用，来创建阴影。
         */
    this.shadowColor = "#000000";
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.shadowOffsetX=0]
         * @description 阴影 X 方向偏移值。
         */
    this.shadowOffsetX = 0;
    /**
         * @member {number} TongMap.ThemeStyle.prototype.shadowOffsetY
         * @description Y 方向偏移值。
         */
    this.shadowOffsetY = 0;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.label]
         * @description 专题要素附加文本标签内容。
         */
    this.label = "";
    /**
         * @member {boolean} [TongMap.ThemeStyle.prototype.labelRect=false]
         * @description 是否显示文本标签矩形背景。
         */
    this.labelRect = false;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.fontColor]
         * @description 附加文本字体颜色。
         */
    this.fontColor = "";
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.fontSize=12]
         * @description 附加文本字体大小,单位是像素。
         */
    this.fontSize = 12;
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.fontStyle="normal"]
         * @description 附加文本字体样式。可设值："normal", "italic", "oblique"。
         */
    this.fontStyle = "normal";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.fontVariant="normal"]
         * @description 附加文本字体变体。可设值："normal", "small-caps"。
         */
    this.fontVariant = "normal";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.fontWeight="normal"]
         * @description 附加文本字体粗细。可设值："normal", "bold", "bolder", "lighter"。
         */
    this.fontWeight = "normal";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.fontFamily="arial,sans-serif"]
    ...
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.labelPosition='top']
         * @description 附加文本位置, 可以是 'inside', 'left', 'right', 'top', 'bottom'。
         */
    this.labelPosition = "top";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.labelAlign='center']
         * @description 附加文本水平对齐。可以是 'left', 'right', 'center'。
         */
    this.labelAlign = "center";
    /**
         * @member {string} [TongMap.ThemeStyle.prototype.labelBaseline='middle']
         * @description  附加文本垂直对齐。 可以是 'top', 'bottom', 'middle'。
         */
    this.labelBaseline = "middle";
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.labelXOffset=0]
         * @description  附加文本在 X 轴方向的偏移量。
         */
    this.labelXOffset = 0;
    /**
         * @member {number} [TongMap.ThemeStyle.prototype.labelYOffset=0]
