...
/**
 * @class ol.source.TileTongMapRest
 * @category iServer Map
 * @classdesc TongMap iServer TileImage 图层源。
 ...
 * @param {TongMap.ServerType} [options.serverType=ServerType.ISERVER] - 服务类型 iServer|iPortal|online。
 ...
 * @param {TongMap.OverlapDisplayedOptions} [options.overlapDisplayedOptions] - 避免地图对象压盖显示的过滤选项，当 overlapDisplayed 为 false 时有效，用来增强对地图对象压盖时的处理。
 ...
 * @param {(TongMap.NDVIParameter|TongMap.HillshadeParameter)} [options.rasterfunction] - 栅格分析参数。
 * @extends {ol/source/TileImage}
 */
export class TileDeurMapRest extends TileImage {
  constructor(options) {
    options = options || {};
    ...
    options.attributions = options.attributions || 'Map Data © 2018 Baidu - GS(2016)2089号 - Data © 长地万方 with <span>© <a>TongMap</a></span>';
    ...
    /**
         * @function  ol.source.TileTongMapRest.prototype.getAllRequestParams
    ...
    function getAllRequestParams() {
      ...
      if (options.clipRegion instanceof Geometry) {
        ...
        options.clipRegion = Util.toTongMapGeometry(new GeoJSON().writeGeometryObject(options.clipRegion));
    ...
    /**
         * @function  ol.source.TileTongMapRest.prototype.getFullRequestUrl
    ...
    /**
         * @function  ol.source.TileTongMapRest.prototype.createLayerUrl
    ...
    /**
         * @function  ol.source.TileTongMapRest.prototype.getRequestParamString
    ...
    function tileUrlFunction(tileCoord, pixelRatio, projection) {
      if (!me.tileGrid) {
        if (options.extent) {
          me.tileGrid = TileTongMapRest.createTileGrid(options.extent);
          if (me.resolutions) {
            me.tileGrid.resolutions = me.resolutions;
          }
        } else {
          if (projection.getCode() === 'EPSG:3857') {
            me.tileGrid = TileTongMapRest.createTileGrid([-20037508.3427892, -20037508.3427892, 20037508.3427892, 20037508.3427892]);
            me.extent = [-20037508.3427892, -20037508.3427892, 20037508.3427892, 20037508.3427892];
          }
          if (projection.getCode() === 'EPSG:4326') {
            me.tileGrid = TileTongMapRest.createTileGrid([-180, -90, 180, 90]);
  ...
  /**
     * @function  ol.source.TileTongMapRest.prototype.setTileSetsInfo
     * @description 设置瓦片集信息。
  ...
  /**
     * @function  ol.source.TileTongMapRest.prototype.lastTilesVersion
  ...
  /**
     * @function  ol.source.TileTongMapRest.prototype.nextTilesVersion
  ...
  /**
     * @function  ol.source.TileTongMapRest.prototype.changeTilesVersion
  ...
  /**
     * @function  ol.source.TileTongMapRest.prototype.updateCurrentTileSetsIndex
  ...
  /**
     * @function  ol.source.TileTongMapRest.prototype.mergeTileVersionParam
  ...
  /**
     * @function  ol.source.TileTongMapRest.optionsFromMapJSON
  ...
  /**
     * @function  ol.source.TileTongMapRest.createTileGrid
     * @description 创建切片网格。
