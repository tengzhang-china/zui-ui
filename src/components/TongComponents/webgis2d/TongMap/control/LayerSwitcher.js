 ...
 * @Description: 图层控制器
 * @FilePath: \TongMap\control\LayerSwitcher .js
 */
import Control from 'ol/control/Control';
import { unByKey } from 'ol/Observable';
import { uuid } from '../utils/mix';

var CSS_PREFIX = 'layer-switcher-';

/**
 * @class ol.tongmap.control.LayerSwitcher
 * @constructor
 * @category  Control
 * @classdesc 图层控制控件
 * @extends {ol/control/Control}
 * @param {Object} options Control options, extends ol/control/Control~Control#options adding:
 * @param {String} options.activationMode Event to use on the button to collapse or expand the panel.
 ...
 * @param {String} options.collapseLabel Text label to use for the expanded layerswitcher button. E.g.:
 *   `'»'` (default) or `'\u00BB'`, `'-'` or `'\u2212'`. Not visible if activation mode is `'mouseover'`
 * @param {String} options.label Text label to use for the collapsed layerswitcher button. E.g.:
 *   `''` (default), `'«'` or `'\u00AB'`, `'+'`.
 * @param {String} options.tipLabel the button tooltip.
...
export class LayerSwitcher extends Control {
  constructor(opt) {
    var options = opt || {};
    console.log(options);
    var tipLabel = options.tipLabel ? options.tipLabel : '图层控制';
